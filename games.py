...
class games:
        ...
        while (True):
            ...
            if response.author.id == int(opponent_id) and response.channel.name == "dueling-club" and response.content == "yes":
                ...
                if (opponent == None or opponent.progress < 4):
                    ...
                    await bot.create_embed(em, message)
                    bot.notFreeUser.remove(int(opponent_id))
                    return None
    ...
    async def staircase(self, bot, currUser, message):
        ...
        if stairs_left == 0:
            ...
            em = embedMessage(colour=discord.Colour.orange(), description=msg,
                              image="https://i.pinimg.com/564x/a6/07/a1/a607a1e0670ae4e4fcda1d0e8775144a.jpg")
            await bot.create_embed(em, message)
            return True
            ...
            em = embedMessage(colour=discord.Colour.green(), description=msg,
                              image="https://i.pinimg.com/564x/5a/f9/b3/5af9b3ab462f2de8f55df8326a5d5d31.jpg", author=author, author_url=author_icon)
            await bot.create_embed(em, message)
            eval(currUser.house).add_points(-5)
            return True
    ...
    async def WordChain(self, client, currUser, message):
        ...
        em = embedMessage(colour=discord.Colour.orange(), description=msg,
                          image="https://i.pinimg.com/564x/9a/fa/b1/9afab1f6432397855e25f7dfc05a4470.jpg", title="Word Chain")
        await client.create_embed(em, message)
    ...
    async def Trivia(self, client, currUser, message):
        ...
        em = embedMessage(colour=discord.Colour.orange(), description=msg, title="Nastily Exhausting Wizarding Tests",
                          image="https://i.pinimg.com/564x/65/5f/eb/655feb6696b676e263fb8a6c5992e58e.jpg")
        await client.create_embed(em, message)
        ques_done = []
        s = 0
        while True:
    ...
    async def crossword(self, client, currUser, message):
        ...
        em = embedMessage(colour=discord.Colour.dark_gray(), description=msg, title="Crossword",
                          image="https://i.pinimg.com/564x/94/3e/b9/943eb9647decd2b38d3a4fb3ac81589f.jpg")
        await client.create_embed(em, message)
        ...
        while True:
            ...
            if user_answers == cross[chosen_one]:
                ...
                if response.content == "exit":
                    ...
                    em = embedMessage(
                        colour=discord.Colour.dark_gray(), description=answers)
                    await client.create_embed(em, message)
            ...
            if response1.content in currUser.spells:
                ...
                if random.random() < opponent.prob:
                    if opponent.name not in ["Basilisk", "Werewolf", "Acromantula"]:
                        ...
                        em = embedMessage(colour=discord.Colour.red(
                        ), description=msg, image="https://i.pinimg.com/originals/b7/b6/78/b7b678bdc295fb6dcaac5a5a630b9fa4.gif")
                        await bot.create_embed(em, message)
                    else:
                    ...
                    if damage_amount > 0:
                        ...
                        msg = "***" + opponent.name + " has taken " + \
                            str(damage_amount) + " damage!***"
                        em = embedMessage(
                            colour=discord.Colour.green(), description=msg)
                        await bot.create_embed(em, message)
                    if heal_amount > 0:
                        msg = "***You have healed for " + \
                            str(heal_amount) + " health points!***"
                        em = embedMessage(
                            colour=discord.Colour.green(), description=msg)
                        await bot.create_embed(em, message)
                ...
                if opponent.name not in ["Basilisk", "Werewolf", "Acromantula"]:
                    ...
                    if random.random() < opponent.prob:
                        msg = f"***{oppSpell.name}***"
                        em = embedMessage(colour=discord.Colour.red(
                        ), description=msg, author=opponent.name)
                        await bot.create_embed(em, message)
                        if oppSpell.heal == 0:
                            ...
                            if response1 != None:
                                if response1.content == "exit":
                                    ...
                                    em = embedMessage(colour=discord.Colour.green(
                                    ), description=msg, image="https://i.pinimg.com/originals/b7/b6/78/b7b678bdc295fb6dcaac5a5a630b9fa4.gif")
                                    await bot.create_embed(em, message)
                                else:
    ...
    async def emojis(self, client, currUser, message):
        ...
        em = embedMessage(colour=discord.Colour.blue(), description=msg, title=":european_castle: :sparkles: ",
                          image="https://i.pinimg.com/564x/6a/93/a0/6a93a031e258b391a02bd5e923bb4d64.jpg")
        await client.create_embed(em, message)
        ...
        em = embedMessage(colour=discord.Colour.blue(), description=msg,
                          image="https://i.pinimg.com/564x/f8/f1/47/f8f14754704bd7f89edf32458a376314.jpg")
        await client.create_embed(em, message)
